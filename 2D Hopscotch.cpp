/*
If ty = 0, add all the values present in the matrix such that they 
are at a distance 1 and return the summation of values.
If ty = 1, add all the values present in the matrix such that they 
are at a distances of 1 and 2 and return the summation of values.*/
#include <bits/stdc++.h>
using namespace std;
