/*
Idea is to fill the demands from the nearest house, which will reduce the transport cost. 
If we separate the buyers and sellers and fill the demands from one side it will give us optimal cost.*/
